...
<template>
  <details
    class="accordion"
    :class="[getModifierClasses('accordion', props.nativeIcons ? 'has-native-icons' : undefined)]"
    :open="open"
    @toggle="handleToggle">
      ...
      <slot
        ...
        <svg
          ...
          <path
            ...
            d="M4.29 6.29a.992.992 0 0 0 0 1.403l4.097 4.096a.937.937 0 0 0 1.326 0l4.097-4.096a.992.992 0 0 0-1.403-1.403L9.015 9.683 5.693 6.29a.992.992 0 0 0-1.403 0Z"></path>
        </svg>
      </slot>
...
.accordion {
  ...
  --_gymx-accordion-content-transition: var(
    --gymx-accordion-content-transition,
    block-size 0.5s,
    content-visibility 0.5s
  );
  --_gymx-accordion-content-color-background: var(
    --gymx-accordion-content-color-background,
    transparent
  );
  --_gymx-accordion-content-color-text: var(--gymx-accordion-content-color-text, inherit);
  --_gymx-accordion-content-padding-inline: var(
    --gymx-accordion-content-padding-inline,
    var(--gymx-size-00)
  );
  --_gymx-accordion-content-padding-block: var(
    --gymx-accordion-content-padding-block,
    var(--gymx-size-000)
  );

  --_gymx-accordion-title-transition: var(--gymx-accordion-title-transition, none);
  --_gymx-accordion-title-color-background: var(
    --gymx-accordion-title-color-background,
    transparent
  );
  --_gymx-accordion-title-color-text: var(--gymx-accordion-title-color-text, inherit);
  --_gymx-accordion-title-padding-inline: var(
    --gymx-accordion-title-padding-inline,
    var(--gymx-size-00)
  );
  --_gymx-accordion-title-padding-block: var(
    --gymx-accordion-title-padding-block,
    var(--gymx-size-000)
  );
