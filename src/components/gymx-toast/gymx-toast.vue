...
.toast {
  ...
  --_toast-color-success: var(--toast-color-success, var(--gymx-color-black-12));
  --_toast-color-background-success: var(
    --toast-color-background-success,
    var(--gymx-color-success-9)
  );

  --_toast-color-warning: var(--toast-color-warning, var(--gymx-color-black-12));
  --_toast-color-background-warning: var(
    --toast-color-background-warning,
    var(--gymx-color-warning-9)
  );

  --_toast-color-error: var(--toast-color-error, var(--gymx-color-white-12));
  --_toast-color-background-error: var(--toast-color-background-error, var(--gymx-color-error-9));
